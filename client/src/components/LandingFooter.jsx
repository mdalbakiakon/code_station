...
const LandingFooter = () => {
  return (
    <div className="mt-47 p-2.5">
      <div className="[clip-path:inset(0_round_50px)] w-full min-h-87.5 relative overflow-hidden flex justify-center items-center p-7.5">
        <div className="absolute inset-0">
            <img src="/footer.jpg" alt="" className="w-full h-full object-cover object-center opacity-50"/>
        </div>
